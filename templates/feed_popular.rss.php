...
echo "<channel>\n";
echo "\t<title>Motions Recently Popular with MPs</title>\n";
echo "\t<link>http://www.edms.org.uk/</link>\n";
echo "\t<description>Monitor the Early Day Motions which have recently been most popular with MPs</description>\n";
